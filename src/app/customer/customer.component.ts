...
export class CustomerComponent implements OnInit {
  ...
  constructor(custservice : CustomerService) {
    ...
    this.customerList.push({ 'id_f':1,'code_f': 'C-001','name_f': 'Hnin Hnin','address_f': 'YGN','phone_f': '090909' });
    this.customerList.push({ 'id_f':2,'code_f': 'C-002','name_f': 'Aung Aung','address_f': 'YGN','phone_f': '010101' });
    this.customerList.push({ 'id_f':3,'code_f': 'C-003','name_f': 'Soe Soe ','address_f': 'Taungoo','phone_f': '080808'});
    this.customerList.push({ 'id_f':4,'code_f': 'C-004','name_f': 'Thu Zar','address_f': 'Bgo','phone_f': '858585' });
    this.customerList.push({ 'id_f':5,'code_f': 'C-005','name_f': 'Soe Moe' ,'address_f': 'Bgo','phone_f': '787878'});
